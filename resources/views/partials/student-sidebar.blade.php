...
<aside class="sidebar">
  ...
  <nav class="sidebar-section" aria-label="My Work">
    <span class="sidebar-label">My Work</span>
    <a href="{{ route('student.similarity-check') }}" class="nav-item {{ $active === 'similarity' ? 'active' : '' }}">
      <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
      Similarity Check
    </a>
    <a href="{{ route('student.literature-review') }}" class="nav-item {{ $active === 'literature-review' ? 'active' : '' }}">
      <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5a6 6 0 105.454 8.454l3.096 3.096a1 1 0 001.414-1.414l-3.096-3.096A6 6 0 0011 5zm-2 5h4m-4 3h2"/></svg>
      Literature Review
    </a>
    <a href="{{ route('student.upload') }}" class="nav-item {{ $active === 'upload' ? 'active' : '' }}">
      <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
      Upload Bluebook
    </a>
    <a href="{{ route('student.my-uploads') }}" class="nav-item {{ $active === 'my-uploads' ? 'active' : '' }}">
      <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
      My Uploads
    </a>
