<h2>1. Acceptance of these terms</h2>
  <p>
    C-BAMS (the &ldquo;System&rdquo;) is the bluebook archive of the Camarines Sur Polytechnic
    Colleges (&ldquo;CSPC&rdquo;) Library. By signing in to the System you agree to these Terms and
    Conditions. If you do not agree, do not sign in or use the System.
  </p>
  <p>
  ...
  <p>
    Access is limited to holders of a CSPC institutional email address ending in
    <code>@cspc.edu.ph</code> or <code>@my.cspc.edu.ph</code>. Accounts are created by the CSPC
    Library administrator, or provisioned automatically the first time you sign in with an
    eligible CSPC Google account.
  </p>
  <p>
    Accounts are personal. You may not share your credentials, allow another person to use
    your account, or sign in on another person&rsquo;s behalf. You are responsible for all
  ...
  <p>
    The System is provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis. CSPC
    does not warrant that it will be uninterrupted or error-free, and may suspend access for
    maintenance without prior notice. Automatically extracted text and generated summaries are
    provided as search aids and may contain inaccuracies; always consult the source document
    before relying on or citing its contents.
  </p>
  ...
  <p>
    These terms may be updated from time to time. The date at the top of this page shows when
    they were last changed, and continued use of the System after a change constitutes
    acceptance of the revised terms.
  </p>

  <h2>9. Contact</h2>
  <p>
    Questions about these terms, requests for an account, and requests to have a document
    corrected or withdrawn should be directed to the CSPC Library at
